  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="bg-purple-100 dark:bg-purple-900/20 border-l-4 border-purple-500 rounded-lg p-3 mb-3"
      >
        ...
        <div className="space-y-2 max-h-32 overflow-y-auto">
          {pinnedMessages.map((msg) => (
            <button
              ...
              className="w-full text-left p-2 rounded hover:bg-purple-200 dark:hover:bg-purple-800/50 transition text-sm"
            >
