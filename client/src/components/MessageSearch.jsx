      ...
      >
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            autoFocus
            className="flex-1 px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
          <button
            onClick={onClose}
